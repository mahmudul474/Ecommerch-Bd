            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      href="https://www.google.com/maps/place/Dream+Furniture+BD/@23.7803028,90.4129432,17z/data=!3m1!4b1!4m6!3m5!1s0x3755c73eef2c97c9:0x963c1e6238446c1d!8m2!3d23.7803028!4d90.4129432!16s%2Fg%2F11vj3yx2tg?entry=ttu"
                      className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                    >
                      Showroom Location
                    </Link>
